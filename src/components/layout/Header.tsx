    ...
    <header className="mobile-width m-auto py-10 lg:h-full lg:py-0 lg:flex lg:flex-col lg:justify-between">
      ...
      <nav aria-label="Lista de links para minhas redes">
        <ul className="flex gap-4">
          <li>
            <a
              className="text-3xl lg:text-xl lg:flex lg:items-center lg:gap-2 lg:px-5 lg:py-2 lg:rounded-md lg:bg-gradient-to-b lg:from-light-blue2 lg:to-light-blue4 lg:border lg:border-light-blue7 lg:hover:from-light-blue3 lg:hover:to-light-blue5 lg:hover:border-light-blue8 lg:dark:from-dark-blue4 lg:dark:to-dark-blue2 lg:dark:border-dark-blue7 lg:dark:hover:from-dark-blue5 lg:dark:hover:to-dark-blue3 lg:dark:hover:border-dark-blue8"
